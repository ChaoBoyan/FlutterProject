...
Future getLiveTVCategoryHttp() async {

  try{
    final String httpUrl = "https://idx.3g.yy.com/mobyy/navs?channel=appstore&compAppid=yymip&hdid=269ee537c7deef169a73910c294eb2918db7cc7e&ispType=2&netType=2&osVersion=11.3&stype=2&uid=432353578&y11=4b09872c706ef60142f1bdaef5a6f807&y12=9d8393ec004d98b7e20f0c347c3a8c24&yv=1&yyVersion=7.30.0";
    Response response;
    var dio = Dio();
    print("直播 ---getLiveTVCategoryHttp---");
    Options options = Options();
    options.headers = httpHeaders;
    response = await dio.get(
        httpUrl,
